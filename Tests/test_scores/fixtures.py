...
def new_fan():
    delays = create_delay_scores(datetime.datetime(2020, 9, 12, 18, 32, 34), None, time_now)
    return add_badge(1, 2, delays)

@pytest.fixture(scope='function')
def top_fan():
    delays = create_delay_scores(datetime.datetime(2020, 9, 12, 18, 32, 34), datetime.datetime(2020, 9, 20, 18, 32, 34), time_now)
    return add_badge(3, 2, delays)

@pytest.fixture(scope='function')
def trend_fan():
    delays = create_delay_scores(datetime.datetime(2021, 1, 31, 18, 32, 34), datetime.datetime(2021, 2, 1, 18, 32, 34), time_now)
    return add_badge(2, 2, delays)

@pytest.fixture(scope='function')
def re_engaged_fan():
    delays = create_delay_scores(datetime.datetime(2021, 1, 31, 18, 32, 34),datetime.datetime(2020, 9, 12, 18, 32, 34), time_now)
    return add_badge(2, 2, delays)

@pytest.fixture(scope='function')
def other_fan():
    delays = create_delay_scores(datetime.datetime(2020, 9, 12, 18, 32, 34), datetime.datetime(2020, 9, 12, 18, 32, 34), time_now)
    return add_badge(2, 2, delays)

@pytest.fixture(scope='function')
def growth():
    delays = create_delay_scores(datetime.datetime(2020, 9, 12, 18, 32, 34), datetime.datetime(2020, 9, 18, 18, 32, 34), time_now)
